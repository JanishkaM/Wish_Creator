  ...
  return (
    <footer className="container mx-auto mt-20 p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6">
		...
		<ul className="flex flex-wrap items-center mt-3 sm:mt-0">
			<li>
				<a href="#" className="mr-4 text-sm text-gray-500 hover:underline md:mr-6 dark:text-gray-400"><i className="bi bi-facebook"></i> About</a>
			</li>
			<li>
				<a href="#" className="mr-4 text-sm text-gray-500 hover:underline md:mr-6 dark:text-gray-400"><i className="bi bi-envelope-paper-heart-fill"></i> Send Message</a>
			</li>
		</ul>
	</footer>
  )
